...
class DeleteBookHelpFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        tip.setText(R.string.delete_book_help)
        image.setImageResource(R.drawable.help_delete_book)
    }

    companion object {
        fun newInstance() = DeleteBookHelpFragment()
    }
}