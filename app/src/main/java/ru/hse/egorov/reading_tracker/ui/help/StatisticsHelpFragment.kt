...
class StatisticsHelpFragment : Fragment() {
    ...
    private fun setUpViewPager(view: View) {
        ...
        pagerAdapter.addFragment(EditSessionHelpFragment.newInstance(), "")
        pagerAdapter.addFragment(DeleteSessionHelpFragment.newInstance(), "")
        view.helpPager.adapter = pagerAdapter
    }

    companion object {
        fun newInstance() = StatisticsHelpFragment()
    }
}